...
{$('#'+format+'_export_files a').each(function(index,element){var iframe=$('<iframe style="visibility: collapse;"></iframe>');iframe[0].src=$(element).attr('href');$('body').append(iframe);setTimeout(function(){iframe.remove()},30000)})};var laststate_alerts=!0;function toggleAlerts()
{$("[name^=alert_]").each(function(key)
{$(this).prop('checked',laststate_alerts)});laststate_alerts=!laststate_alerts}
var laststate_email=!0;function toggleMail()
{$("[name^=email_]").each(function(key)
{$(this).prop('checked',laststate_email)});laststate_email=!laststate_email};var pingTime=10000;var notificationIcon='/favicon.ico';$(function()

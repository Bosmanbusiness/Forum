...
function template_main()
{
	...
	if (!empty($context['normal_buttons']))
		echo '
		<div class="mobile_buttons flex floatright">
			<a class="btn_tertiary mobile_act">', $txt['mobile_action'], '</a>
			', !empty($context['mod_buttons']) ? '<a class="btn_tertiary mobile_mod">' . $txt['mobile_moderation'] . '</a>' : '', '
		</div>';
...
function template_single_post($message)
{
	...
	echo '
				<div class="window" id="msg' . $message['id'] . '">
